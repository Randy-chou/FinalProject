...
public class BattleshipGame {
	...
	/**
	 * Begins a battleship game in the console for the user to play
	 */
	 ...
	 * 
	 * @param x   row to shoot at
	 * @param y   column to shoot at
	 */
	 ...
	 * 
	 * @param coord   the coordinate asked for
	 * @return valid int value from user input
	 */
	...
	/**
	 * Starts the game upon program start
	 * 
